...
{
    Vacuum_Gripper::Vacuum_Gripper() : Node("vacuum_gripper_node")
    {
        ...
        _open_vacuum_gripper_srv = this->create_service<std_srvs::srv::Trigger>("open_vacuum_gripper", std::bind(&Vacuum_Gripper::open_vacuum_gripper, this, _1, _2));
        _close_vacuum_gripper_srv = this->create_service<std_srvs::srv::Trigger>("close_vacuum_gripper", std::bind(&Vacuum_Gripper::close_vacuum_gripper, this, _1, _2));
        RCLCPP_INFO(rclcpp::get_logger("vacuum_gripper_node"), "Ready to receive commands.");
    }

    void Vacuum_Gripper::close_vacuum_gripper(const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
          std::shared_ptr<std_srvs::srv::Trigger::Response>      response)
    {
        rclcpp::Rate loop_rate(50);
        const std::vector<int> set_io_pins_cmd{5, 6};
        ...
        // }
        // bool opened = false;
        // const std::vector<int> io_pins_cmd{5, 6};
    ...
    void Vacuum_Gripper::open_vacuum_gripper(const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
        std::shared_ptr<std_srvs::srv::Trigger::Response> response)
    {
        rclcpp::Rate loop_rate(50);
        const std::vector<int> set_io_pins_cmd{5, 6};
